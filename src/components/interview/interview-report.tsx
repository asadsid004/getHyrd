...
export const InterviewReport = ({ id }: { id: string }) => {
  ...
  if (!data) {
    return (
      <div className="flex items-center justify-center mt-10">
        <div className="text-center space-y-4">
          <p className="text-2xl font-bold text-muted-foreground">Error</p>
          <p className="text-muted-foreground">
            There was an error generating your interview report. Please try
            again later.
          </p>
    ...
    <div className="min-h-screen">
      ...
      <Tabs defaultValue="report" className="w-full">
        ...
        <TabsContent value="report" className="space-y-6">
          <div className="rounded-2xl bg-muted p-6 space-y-6">
            {/* Header Card */}
            ...
            {reportLoading ? (
              ...
              <div className="flex items-center justify-center mt-10">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    There was an error loading your answers. Please try again
                    later.
                  </p>
                </div>
              </div>
                    ...
                    <div>
                      ...
                      {response.selectedOption !== "" ? (
                        <div className="mb-3">
                          ...
                          >
                            ...
                            {(() => {
                              ...
                              switch (option) {
                                case "A":
                                  return response.question.optionA;
                                case "B":
                                  return response.question.optionB;
                                case "C":
                                  return response.question.optionC;
                                case "D":
                                  return response.question.optionD;
                                default:
                                  return "";
                              }
                            })()}
                        ...
                        <div className="mb-3">
                          ...
                          <div className="p-3 rounded-lg border bg-gray-50 border-gray-200 dark:bg-gray-950/30 dark:border-gray-900">
                      ...
                      {/* Correct answer (show if user was wrong or didn't answer) */}
                      {(response.isCorrect === 0 ||
                        ...
                        <div className="mb-3">
                          ...
                          <div className="p-3 rounded-lg border bg-green-50 border-green-200 dark:bg-green-950/30 dark:border-green-900">
                            <span className="font-medium">
                              {response.question.correctOption}.
                            </span>{" "}
                            {(() => {
                              const option = response.question.correctOption;
                              switch (option) {
                                case "A":
                                  return response.question.optionA;
                                case "B":
